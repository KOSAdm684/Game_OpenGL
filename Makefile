...
main: debug/Tower.o debug/Model.o debug/Tank.o debug/Shader.o debug/main.o
	$(CXX) $(CXXFLAGS) -o main debug/Tower.o debug/Model.o debug/Tank.o debug/Shader.o debug/main.o -lGL -lGLU -lGLEW -lglfw -lX11 -lXxf86vm -lXrandr -lXi -lXinerama -lXcursor -lpthread -lfreetype -ldl
...
clean: 
	rm -f main debug/Tower.o debug/Model.o debug/Tank.o debug/Shader.o debug/main.o
